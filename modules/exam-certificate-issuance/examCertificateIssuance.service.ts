...
//     // 🔧 FIX: Prisma returns Decimal-typed columns as Decimal.js objects at
//     // runtime, not primitive numbers. achievementCertificateService.getBandForPercentage
//     // does a strict `typeof percentage !== "number"` check, which would
//     // otherwise throw "A valid percentage is required." on every call even
//     // though the value is perfectly valid — this coercion fixes that.
