...
export const examCertificateIssuanceRepository = {
  ...
  /**
   * Completed attempts for this student that don't have an ExamCertificate
   * row yet. Lets the list endpoint self-heal instead of depending on the
   * per-attempt certificate endpoint having been hit first.
   */
  async findAttemptsNeedingCertificate(studentId: number) {
