...
//   studentName = "Ganesh Haridas Ingle",
...
//           .signature-section {
//   position: absolute;
//   bottom: 9%;          /* Was 7% - moves the whole section upward */
//   right: 7%;
//   display: flex;
//   flex-direction: column;
//   align-items: center;
...
//   width: auto;
//   object-fit: contain;
//   margin-bottom: -12px; /* Signature touches the line naturally */
// }
...
//   return (
//     <div className="w-full flex flex-col items-center justify-center bg-neutral-100 p-4 sm:p-8 gap-4">
//       <button
//         onClick={downloadPDF}
...
//           <div className="absolute right-0 top-0 h-full w-[10%] bg-[#a9d24a]" style={{ clipPath: "polygon(0 0, 100% 0, 70% 100%, 0 100%)" }} />
...
//           <h1 className="font-black text-[#141414] leading-none tracking-tight text-[8vw] sm:text-[4.6vw]" style={{ fontFamily: "'Pirata One'" }}>
//             CERTIFICATE
//           </h1>
...
//           <p className="mt-1 text-[9vw] sm:text-[4vw] text-[#141414] leading-none inline-block border-b-2 border-[#3a1650] pb-2 pr-10 w-fit" style={{ fontFamily: "'Brush Script MT', 'Segoe Script', cursive" }}>
//             {studentName}
//           </p>
...
import CertificateGradeMaster from "./Certificategrademaster ";

export const metadata = {
  title: "Gradewise Certificate Master",
};

export default function GradeWiseCertificatePage() {
  return <CertificateGradeMaster />;
}
