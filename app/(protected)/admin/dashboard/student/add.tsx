          ...
          <Field label="Full Name" icon={<Ic.Person />} required error={errors.name}>
            <input
              ...
              style={{
                ...
                background: "#0f1117",
                border: `1px solid ${errors.name ? "#7f1d1d" : "#2d3448"}`,
                borderRadius: 9,
                color: "#e2e8f0",
                fontSize: "0.875rem",
                outline: "none",
            ...
            <Field label="Email" icon={<Ic.Mail />} required error={errors.email}>
              <input
                ...
                style={{
                  ...
                  padding: "0.65rem 0.9rem",
                  background: "#0f1117",
                  border: `1px solid ${errors.email ? "#7f1d1d" : "#2d3448"}`,
                  borderRadius: 9,
                  color: "#e2e8f0",
                  fontSize: "0.875rem",
                  outline: "none",
            ...
            <Field label="Phone" icon={<Ic.Phone />} required error={errors.phone}>
              <input
                ...
                style={{
                  ...
                  padding: "0.65rem 0.9rem",
                  background: "#0f1117",
                  border: `1px solid ${errors.phone ? "#7f1d1d" : "#2d3448"}`,
                  borderRadius: 9,
                  color: "#e2e8f0",
                  fontSize: "0.875rem",
                  outline: "none",
            ...
            <Field label="Date of Birth" icon={<Ic.Calendar />} error={errors.dob}>
              <input
                ...
                style={{
                  ...
                  padding: "0.65rem 0.9rem",
                  background: "#0f1117",
                  border: `1px solid ${errors.dob ? "#7f1d1d" : "#2d3448"}`,
                  borderRadius: 9,
                  color: "#e2e8f0",
                  fontSize: "0.875rem",
                  outline: "none",
            ...
            <Field label="Parent / Guardian Name" icon={<Ic.Person />} error={errors.parentName}>
              <input
                ...
                style={{
                  ...
                  padding: "0.65rem 0.9rem",
                  background: "#0f1117",
                  border: `1px solid ${errors.parentName ? "#7f1d1d" : "#2d3448"}`,
                  borderRadius: 9,
                  color: "#e2e8f0",
                  fontSize: "0.875rem",
                  outline: "none",
            ...
            <Field label="Parent Phone" icon={<Ic.Phone />} required error={errors.parentPhone}>
              <input
                ...
                style={{
                  ...
                  padding: "0.65rem 0.9rem",
                  background: "#0f1117",
                  border: `1px solid ${errors.parentPhone ? "#7f1d1d" : "#2d3448"}`,
                  borderRadius: 9,
                  color: "#e2e8f0",
                  fontSize: "0.875rem",
                  outline: "none",
          ...
          <Field label="Parent Email" icon={<Ic.Mail />} error={errors.parentEmail}>
            <input
              ...
              style={{
                ...
                padding: "0.65rem 0.9rem",
                background: "#0f1117",
                border: `1px solid ${errors.parentEmail ? "#7f1d1d" : "#2d3448"}`,
                borderRadius: 9,
                color: "#e2e8f0",
                fontSize: "0.875rem",
                outline: "none",
